...
class cube:
    ...
    def moveTC(self):
        for i in range(3):
            self.faces[0].cubes[i].color = (255, 0, 0)
        for i in range(3):
            self.faces[1].cubes[i].color = (0, 255, 0)
        for i in range(3):
            self.faces[2].cubes[i].color = (255, 165, 0)
        for i in range(3):
            self.faces[3].cubes[i].color = (0, 0, 255)
    ...
    def moveTA(self):  
        for i in range(3):
            self.faces[1].cubes[i].color = (0, 0, 255)
        for i in range(3):
            self.faces[0].cubes[i].color = (255, 165, 0)
        for i in range(3):
            self.faces[2].cubes[i].color = (255, 0, 0)
        for i in range(3):
            self.faces[3].cubes[i].color = (0 ,255, 0)
        # orange = self.faces[3].cubes[0:3]
        # green = self.faces[2].cubes[0:3]
        # red = self.faces[1].cubes[0:3]
        # blue = self.faces[0].cubes[0:3]
    ...
    def moveFA(self):
        ...
        leftIndices = [0, 3, 6]
        for i in range(3):
            self.faces[5].cubes[i].color = (0, 0, 255)
        for i in rightIndices:
            self.faces[0].cubes[i].color = (255, 255, 0)
        for i in leftIndices:
            self.faces[2].cubes[i].color = (255, 255, 255)
        for i in range(3):
            self.faces[4].cubes[i].color = (0, 255, 0)
    ...
    def moveAC(self):
        ...
        leftIndices = [0, 3, 6]
        for i in range(3):
            self.faces[5].cubes[6 + i].color = (0, 0, 255)
        for i in leftIndices:
            self.faces[0].cubes[i].color = (255, 255, 0)
        for i in range(3):
            self.faces[4].cubes[6 + i].color = (0, 255, 0)
        for i in rightIndices:
            self.faces[2].cubes[i].color = (255, 255, 255)
